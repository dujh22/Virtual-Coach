...
{"id": 2, "node_type": "send_audio_dispatch", "node_name": "audio_dispatch_00", "key_node": true, "input_map": {"pkg_step": "judge_00.pkg_step", "adjust": "judge_00.adjust", "status": "judge_00.status"}, "choice_map": {"good": "finish", "improved": "receive_01", "not_improved": "receive_01", "other_problem": "receive_01"}, "attrs": {"audio_url": {"good": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/good_0.wav", "text": "厉害，一次就调整到位了，咱们继续。"}, "improved": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/error_0_qukuan.wav", "text": "这次深蹲屈髋的幅度还不够，要再多点，你再做一个我看看"}, "not_improved": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/error_0_qukuan.wav", "text": "这次深蹲屈髋的幅度还不够，要再多点，你再做一个我看看"}, "other_problem": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/other_problem_1.wav", "text": "也不用刻意往后蹲很多，背都弯了，稍微回来点，再来一个"}}}}
{"id": 5, "node_type": "send_audio_dispatch", "node_name": "audio_dispatch_01", "key_node": true, "input_map": {"pkg_step": "judge_01.pkg_step", "adjust": "judge_01.adjust", "status": "judge_01.status"}, "choice_map": {"good": "finish", "improved": "receive_02", "not_improved": "receive_02", "other_problem": "receive_02"}, "attrs": {"audio_url": {"good": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/good_0.wav", "text": "厉害，一次就调整到位了，咱们继续。"}, "improved": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/improved_1.wav", "text": "很好，你的屈髋幅度比上一个动作有明显进步，我们再来一个"}, "not_improved": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/not_improved_1.wav", "text": "加油，屈髋再多一些，我们再来一个"}, "other_problem": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/other_problem_1.wav", "text": "也不用刻意往后蹲很多，背都弯了，稍微回来点，再来一个"}}}}
{"id": 8, "node_type": "send_audio_dispatch", "node_name": "audio_dispatch_02", "key_node": true, "input_map": {"pkg_step": "judge_02.pkg_step", "adjust": "judge_02.adjust", "status": "judge_02.status"}, "choice_map": {"good": "finish", "improved": "llm_stream_02", "not_improved": "receive_03", "other_problem": "receive_03"}, "attrs": {"audio_url": {"good": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/good_1.wav", "text": "厉害，一次就调整到位了，咱们继续。"}, "improved": {"type": "tts"}, "not_improved": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/not_improved_1.wav", "text": "加油，屈髋再多一些，我们再来一个"}, "other_problem": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/other_problem_1.wav", "text": "也不用刻意往后蹲很多，背都弯了，稍微回来点，再来一个"}}}}
{"id": 14, "node_type": "send_audio_dispatch", "node_name": "audio_dispatch_03", "key_node": true, "input_map": {"pkg_step": "judge_03.pkg_step", "adjust": "judge_03.adjust", "status": "judge_03.status"}, "choice_map": {"good": "finish", "improved": "llm_stream_03", "not_improved": "llm_stream_03", "other_problem": "llm_stream_03"}, "attrs": {"audio_url": {"good": {"type": "url", "url": "https://test-content-1315251994.cos.ap-shanghai.myqcloud.com/service_audio/good_2.wav", "text": "厉害，一次就调整到位了，咱们继续。"}, "improved": {"type": "tts"}, "not_improved": {"type": "tts"}, "other_problem": {"type": "tts"}}}}
