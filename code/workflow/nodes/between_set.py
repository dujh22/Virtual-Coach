        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                resp = await client.get(
                    url="http://124.220.227.97:48080/app-api/resources/user-action-log/new-get-group-summary-text",
                    params={
    ...
    async def run(self, input_parameters: dict=[]):
        ...
        try:
            ...
            await self.set_output('pic', {
                ...
                'data': {
                    'type': 'url',
                    'url': 'https://action-info.tos-s3-cn-shanghai.volces.com/2f08fa12d2a8127ebfddcfee6e7abf75a96c0a9e732a74947d25594198e8996a.png'
                }
            })
